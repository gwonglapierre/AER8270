...
prob = HSPM.HSPM(panels,alpha,[0.25,0.,0.])
...
fig.suptitle("Coefficients aérodynamiques d'un profil NACA 4412 par la méthode HSPM", fontsize=16)
fig.set_figwidth(8)
...
plt.savefig('AER8270_TD1_2g.png',dpi=300)
plt.show()